...
class SegmentationModelNoSmoothConv(nn.Module):
    def __init__(self, num_classes):
        super(SegmentationModelNoSmoothConv, self).__init__()
...
def visualize_predictions(model, dataloader, num_images=10, save_path = 'UnetPyr_ablation_BUSI.png'):
    model.eval()
    lesion_cases = []
...
if __name__ == "__main__":
    ...
    model = SegmentationModelNoSmoothConv(num_classes=1)
...
visualize_predictions(model, test_loader, num_images=10, save_path='UnetPyr_ablation_BUSI.png')